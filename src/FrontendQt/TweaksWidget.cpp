	...
	: QWidget(parent)
{
	...
	GuiSettings::setToolTip(m_ui.tweaksUnlockCostumeByDefault, 
		"Allows you to choose secondary costumes even if you have never beaten the game.");

	GuiSettings::setToolTip(m_ui.tweaksExpandHeroAndLegendShops,
	...
	GuiSettings::setToolTip(m_ui.tweaks60To50LegendDifficultyLevelRequirement,
		"Lower the Legend's difficulty requirements to 50 to make it more accessible.");

	GuiSettings::setToolTip(m_ui.tweaksPermanentShopsItems,
	...
	GuiSettings::setToolTip(m_ui.tweaksSpellDurability3Stacks,
	...
	GuiSettings::setToolTip(m_ui.tweaksTalkToNPCsWhileInvisible, "Allows you to talk to NPCs when Invisibility is active.");
	GuiSettings::setToolTip(m_ui.tweaksHideLevelUpXPIfStatsAreAtMaximum,
	...
	GuiSettings::setToolTip(m_ui.fixesExpBarGlitch,
		"From level 50 due to a type overflow the exp bar is not displayed correctly, this fixes it."
	);

	GuiSettings::setToolTip(m_ui.fixesCantSaveIfLevel59,
	...
	GuiSettings::setToolTip(m_ui.fixesTheftBlock,
	...
	GuiSettings::setToolTip(m_ui.fixesTheftEmptyJewelry,
	...
	GuiSettings::setToolTip(m_ui.duckStation60FPS,
